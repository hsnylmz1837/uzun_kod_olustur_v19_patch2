...
# --- v19_patch3: helper for rerun + home + label CSS ---
def _force_rerun():
    # bump a dummy state key then rerun
...
def _go_home():
    # clear user-facing state and restart app
    for _k in list(st.session_state.keys()):
        # keep Streamlit internals (start with '_') untouched
...
.stepbtns div[data-testid="column"] .stButton>button{width:100%;height:120px;padding:12px 16px;font-size:72px;font-weight:700;border-radius:18px;border:1px solid #334155;background:#0b1220;color:#e5e7eb;}
