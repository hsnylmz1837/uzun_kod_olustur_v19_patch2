...
.stepbtns div[data-testid="column"] .stButton>button{width:100%;height:12px;padding:12px 16px;font-size:28px;font-weight:700;border-radius:18px;border:1px solid #334155;background:#0b1220;color:#e5e7eb;}
